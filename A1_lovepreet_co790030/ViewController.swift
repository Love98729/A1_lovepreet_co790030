...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let lg = UILongPressGestureRecognizer(target: self, action: #selector(addLongPressAnnotattion))
        map.addGestureRecognizer(lg)
